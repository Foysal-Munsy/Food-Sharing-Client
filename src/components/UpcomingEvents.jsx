...
const UpcomingEvents = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* BG Decorations */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-green-200/30 to-transparent rounded-full blur-3xl -translate-x-36 -translate-y-36"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-lime-200/30 to-transparent rounded-full blur-3xl translate-x-48 translate-y-48"></div>
      ...
      >
        ...
        <motion.div className="text-center mb-16">
          <motion.h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 mb-6 tracking-tight">
            Upcoming Events
          </motion.h2>
